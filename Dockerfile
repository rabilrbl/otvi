...
COPY Cargo.toml Cargo.lock ./
COPY crates crates
# cargo-chef only needs Cargo.toml files to prepare the dependency recipe.
# We need to create minimal dummy source files so cargo can validate the workspace.
