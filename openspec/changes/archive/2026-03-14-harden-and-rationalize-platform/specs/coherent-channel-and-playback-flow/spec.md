...
The frontend MUST use route-aware internal navigation for in-app transitions so navigation between home, admin, channels, login, and player views does not trigger unnecessary full-page reloads.
