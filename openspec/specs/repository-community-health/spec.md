...
- **THEN** the documentation explicitly lists settings such as default branch, branch protection, and default pull request base behavior that must be configured in GitHub
